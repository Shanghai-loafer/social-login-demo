...
public class SocialLoginDemoApplication {
	 ...
	 * 		b. ページへ飛ばすことができねー。どういうリソースへの制御してるんだ？
	 * テンプレートエンジンのルールに乗っ取らないとcssが参照されないようだ。このままだと生のhtmlしか出力できないし、参照がおかしくなる。
	 * Reactで生成したものを無理やりというのはダメだよなー。ということは別のサーバたてるしかないってことか？
	 * 一応無理やり書き換えたら、動くことは確認できたけど、そういうレベルの話では無い。
	 */
